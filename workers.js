...
<head>
    ...
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path d='M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z' fill='%2343b883'/></svg>">
...
<body class="min-h-screen font-sans text-slate-800 dark:text-slate-100 selection:bg-emerald-200 dark:selection:bg-emerald-900 transition-colors duration-300">
    ...
    const engineList = ['site', 'bing', 'baidu', 'google'];;
    ...
    function initializeUIComponents() {
        ...
        currentEngine = (savedPref && localStorage.getItem('searchEngine')) || 'bing';
